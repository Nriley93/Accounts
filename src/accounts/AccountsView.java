...
import business.CreditAccount;
import business.CreditCard;
import business.EquityLine;
...
public class AccountsView extends FrameView {
    ...
    private void initComponents() {
        ...
        jlblEquityLine = new javax.swing.JLabel();
        jtxtEquityLine = new javax.swing.JTextField();
        jlblCreditLimit = new javax.swing.JLabel();
        jtxtCreditLimit = new javax.swing.JTextField();
        ...
        jmnuMoneyMarket = new javax.swing.JMenuItem();
        ...
        jlblEquityLine.setFont(resourceMap.getFont("jlblEquityLine.font")); // NOI18N
        jlblEquityLine.setText(resourceMap.getString("jlblEquityLine.text")); // NOI18N
        jlblEquityLine.setName("jlblEquityLine"); // NOI18N

        jtxtEquityLine.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jtxtEquityLine.setText(resourceMap.getString("jtxtEquityLine.text")); // NOI18N
        jtxtEquityLine.setName("jtxtEquityLine"); // NOI18N

        jlblCreditLimit.setFont(resourceMap.getFont("jlblCreditLimit.font")); // NOI18N
        jlblCreditLimit.setText(resourceMap.getString("jlblCreditLimit.text")); // NOI18N
        jlblCreditLimit.setName("jlblCreditLimit"); // NOI18N

        jtxtCreditLimit.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jtxtCreditLimit.setText(resourceMap.getString("jtxtCreditLimit.text")); // NOI18N
        jtxtCreditLimit.setName("jtxtCreditLimit"); // NOI18N

        jtxtAvailable.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jtxtAvailable.setText(resourceMap.getString("jtxtAvailable.text")); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtxtBalance, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxtCreditLimit, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(47, 47, 47)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jlblEquityLine)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jtxtEquityLine, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jlblAvailable)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jtxtAvailable, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(33, 33, 33)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jtxtAcctTypeDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(54, 54, 54)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jlblStartVal2, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jlblCreditLimit)
                        .addComponent(jtxtCreditLimit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jlblEquityLine)
                        .addComponent(jtxtEquityLine, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jmnuMoneyMarket.setText(resourceMap.getString("jmnuMoneyMarket.text")); // NOI18N
        jmnuMoneyMarket.setName("jmnuMoneyMarket"); // NOI18N
        jmnuMoneyMarket.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmnuMoneyMarketActionPerformed(evt);
            }
        });
        jmnuAsset.add(jmnuMoneyMarket);

        fileMenu.add(jmnuAsset);

        jmnuExisting.setText(resourceMap.getString("jmnuExisting.text")); // NOI18N
        jmnuExisting.setName("jmnuExisting"); // NOI18N
        jmnuExisting.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmnuExistingActionPerformed(evt);
            }
        });
        fileMenu.add(jmnuExisting);
    ...
    private void jmnuSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmnuSVActionPerformed
        ...
        jtxtCreditLimit.setVisible(false);
        jtxtEquityLine.setVisible(false);
        jtxtAvailable.setVisible(false);
        jlblCreditLimit.setVisible(false);
        jlblEquityLine.setVisible(false);
    ...
    private void jbtnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCreateActionPerformed
       ...
       statusMessageLabel.setText("");
        ...
        switch (jtxtTypeCd.getText()){
            case Savings.TYPECD:
                a = new Savings(jtxtAcctNm.getText(),sbal);
                break;
            case Checking.TYPECD:
                a = new Checking(jtxtAcctNm.getText(),sbal);
                break;
            case MoneyMarket.TYPECD:
                a = new MoneyMarket(jtxtAcctNm.getText(), sbal);
                break;
            case CreditCard.TYPECD:
                a = new CreditCard(jtxtAcctNm.getText(),sbal);
                jtxtCreditLimit.setText(curr.format(((CreditAccount)a).getCreditLimit()));
                jtxtAvailable.setText(curr.format(((CreditAccount)a).getAvailCredit()));
                break;
            case EquityLine.TYPECD:
                a = new EquityLine(jtxtAcctNm.getText(),sbal);
                jtxtCreditLimit.setText(curr.format(((CreditAccount)a).getEquity(sbal)));
                jtxtAvailable.setText(curr.format(((CreditAccount)a).getAvailCredit()));
                jtxtEquityLine.setText(curr.format(sbal));
                break;
            default:
                statusMessageLabel.setText(
    ...
    private void jbtnPmtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPmtActionPerformed
        ...
        try{
            ...
            } else if(jtxtAcctTypeCd.getText().equalsIgnoreCase(MoneyMarket.TYPECD)) {
                a.setPayment(amt);
                if (a.getErrMsg().isEmpty()) {
                    statusMessageLabel.setText(a.getActionMsg());
                    jtxtBalance.setText(curr.format(a.getBalance()));
            ...
            } else if(jtxtAcctTypeCd.getText().equalsIgnoreCase(CreditCard.TYPECD)) {
                a.setPayment(amt);
                if (a.getErrMsg().isEmpty()) {
                    statusMessageLabel.setText(a.getActionMsg());
                    jtxtBalance.setText(curr.format(a.getBalance()));
            ...
            } else if(jtxtAcctTypeCd.getText().equalsIgnoreCase(EquityLine.TYPECD)) {
                a.setPayment(amt);
                if (a.getErrMsg().isEmpty()) {
                    statusMessageLabel.setText(a.getActionMsg());
                    jtxtBalance.setText(curr.format(a.getBalance()));
    ...
    private void jmnuMoneyMarketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmnuMoneyMarketActionPerformed
        setInputLine(true);
        ...
        jlblAvailable.setVisible(false);
        jtxtAcctNm.requestFocusInWindow();
    }//GEN-LAST:event_jmnuMoneyMarketActionPerformed
    ...
    chooser.setDialogTitle("Select Account File");
    FileNameExtensionFilter filter = 
                new FileNameExtensionFilter("TXT File (.txt)", "txt");
    chooser.setFileFilter(filter);
    int returnVal = chooser.showOpenDialog(null);
    if(returnVal == JFileChooser.APPROVE_OPTION) {
        int acctNo = 
            Integer.parseInt(chooser.getSelectedFile().getName().replaceAll("[^0-9]", ""));
        String typeCd = chooser.getSelectedFile().getName().substring(0,2);;
        NumberFormat curr = NumberFormat.getCurrencyInstance();
        jtxtCreditLimit.setVisible(false);
        jtxtEquityLine.setVisible(false);
        jtxtAvailable.setVisible(false);
    ...
    a = null;
        switch (typeCd){
            case Savings.TYPECD:
                a = new Savings(acctNo);
                break;
            case Checking.TYPECD:
                a = new Checking(acctNo);
                break;
            case MoneyMarket.TYPECD:
                a = new MoneyMarket(acctNo);
                break;
            case CreditCard.TYPECD:
                a = new CreditCard(acctNo);
                jtxtCreditLimit.setText(curr.format(((CreditAccount)a).getCreditLimit()));
                jtxtAvailable.setText(curr.format(((CreditAccount)a).getAvailCredit()));
                jtxtCreditLimit.setVisible(true);
                jtxtAvailable.setVisible(true);
                jlblCreditLimit.setVisible(true);
                jlblAvailable.setVisible(true);
                break;
            case EquityLine.TYPECD:
                a = new EquityLine(acctNo);
                jtxtCreditLimit.setText(curr.format(((CreditAccount)a).getCreditLimit()));
                jtxtAvailable.setText(curr.format(((CreditAccount)a).getAvailCredit()));
                jtxtCreditLimit.setVisible(true);
                jtxtAvailable.setVisible(true);
                jlblCreditLimit.setVisible(true);
                jlblAvailable.setVisible(true);
                jlblEquityLine.setVisible(true);
                break;
            default:
                statusMessageLabel.setText(
                "unknown account type");
    ...
    private void jbtnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnLogActionPerformed
        String history = "";
        try {
            for(int i = 0; i < a.getLog().size(); i++) {
                history += a.getLog().get(i)+ "\n";
            }
            JOptionPane.showMessageDialog(null,history,"Display History: " +
                    a.getName(),JOptionPane.INFORMATION_MESSAGE);
        } catch(Exception e) {
            statusMessageLabel.setText("Select an account.");
        }
    ...
    private void jmnuEQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmnuEQActionPerformed
        ...
        jtxtStartVal.setEnabled(true);
        jtxtCreditLimit.setVisible(true);
        jtxtEquityLine.setVisible(true);
        jtxtAvailable.setVisible(true);
        jlblCreditLimit.setVisible(true);
        jlblEquityLine.setVisible(true);
        jlblAvailable.setVisible(true);
    ...
    private javax.swing.JLabel jlblEquityLine;
    ...
    private javax.swing.JMenuItem jmnuMoneyMarket;
    ...
    private javax.swing.JTextField jtxtCreditLimit;
    private javax.swing.JTextField jtxtDisplayName;
    private javax.swing.JTextField jtxtEquityLine;
